...
int main(int argc, char* argv[])
{
    ...
    option_list.add_options()("h,help", "display this help and exit")(
        "version", "display version information and exit")("v,verbose", "be verbose when parsing")(
        "fatal_errors",
        "abort program when a parser error occurs, instead of "
        "doing error correction");

    option_list.add_options("compilation")("infile", "the file that are being parsed",
                                           cxxopts::value<std::string>())(
        "outfile", "the output file that will be generated", cxxopts::value<std::string>())(
        "database_dir",
        ...
        "current file name",
        cxxopts::value<std::string>())("I,include_directory",
